'use strict';
import { SnippetString, workspace, WorkspaceConfiguration } from 'coc.nvim';
import { Tag } from '../../entities/tag';
import { IEntity } from '../../types';

// Helper class to manage empty lines of a snippet
export class SpacerHelper {
  private lastTag: IEntity | undefined = undefined;
  private isFirstTag = false;
  private isFirstTagInGroup = false;
  private isTag = false;
  private isText = false;
  private tagsCount = 0;
  private isSingleEntity = false;
  private isLastEntity = false;
  private isSingleTag = false;
  ...
  public beforeEntity(entity: IEntity, entities: IEntity[], index: number) {
    ...
    const separateTags =
      !this.isFirstTag && this.isFirstTagInGroup && !this.isSingleEntity;
